                ...
                if (result.error == false) {
                    ...
                    $.each(result.data.items, function (i, e) {
                        ...
                        html += '<div class="row">'
                            ...
                            + '<input type="number" class="form-input" value="' + e.qty + '"  data-id="' + e.product_variant_id + '" data-price="' + e.price + '" min="' + min + '" max="' + max + '" step="' + step + '" >'
                            + '</div>'
                    ...
                    var cart_item = { "product_variant_id": product_variant_id.trim(), "title": title, "description": description, "image": image, "price": price.trim(), "qty": '1', "min": min, "step": step };
                ...
                if (result.error == false) {
                    ...
                    $.each(result.data.items, function (i, e) {
                        ...
                        html += '<div class="row">'
                            ...
                            + '<div class="product-price align-self-center">' + currency + ' ' + price + '</div>'
                            + '<div class="product-sm-quantity px-1">'
                            + '<input type="number" class="form-input" value="' + e.qty + '"  data-id="' + e.product_variant_id + '" data-price="' + price + '" min="' + min + '" max="' + max + '" step="' + step + '" >'
                            + '</div>'
                            + '<div class="product-sm-removal align-self-center">'
                            + '<button class="remove-product button button-danger" data-id="' + e.product_variant_id + '">'
                            + '<i class="fa fa-trash"></i>'
                    ...
                    var cart_item = { "product_variant_id": product_variant_id.trim(), "title": title, "description": description, "qty": 1, "image": image, "price": price.trim(), "min": min, "step": step };
                    var cart = localStorage.getItem("cart");
                    cart = (localStorage.getItem("cart") !== null) ? JSON.parse(cart) : null;
                    if (cart !== null && cart !== undefined) {
                        cart.push(cart_item);
