                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/setting/update_system_settings') ?>" method="POST" id="system_setting_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="minimum_cart_amt">Minimum Cart Amount(<?= $currency ?>) <span class='text-danger text-xs'>*</span>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="max_items_cart"> Maximum Items Allowed In Cart <span class='text-danger text-xs'>*</span>
                                            <!-- <a type="button" data-toggle="tooltip" data-placement="top" title=" Below this user will be charged based on Delivery Charge">
                                         <i class="fas fa-info-circle"></i></a>
                                         <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Tooltip : Top</button> -->
                                        </label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="max_items_cart"> Low stock limit <small>(Product will be considered as low stock)</small>
                                            <!-- <a type="button" data-toggle="tooltip" data-placement="top" title=" Below this user will be charged based on Delivery Charge">
                                         <i class="fas fa-info-circle"></i></a>
                                         <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Tooltip : Top</button> -->
                                        </label>
                                ...
                                <span class="d-flex align-items-center ">
                                    ...
                                    <!-- <a href="#" data-toggle="tooltip" title="Hooray!">How it works?</a> -->
                                </span>
                                <hr>
                                <div class="row">
                                    <div class="form-group col-md-2">
