                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th><?= !empty($this->lang->line('total_payable')) ? $this->lang->line('total_payable') : 'Total Payable' ?></th>
                                                <td>+ <?= $settings['currency'] . ' ' . number_format($order['total_payable'], 2) ?> <span class="small text-muted"> <?= !empty($this->lang->line('via')) ? $this->lang->line('via') : 'via' ?> (<?= $order['payment_method'] ?>) </span></td>
                                            </tr>
                                            <tr class="h6">
                                                <th><?= !empty($this->lang->line('final_total')) ? $this->lang->line('final_total') : 'Final Total' ?></th>
                                                <td><?= $settings['currency'] . ' ' . number_format($order['final_total'], 2) ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <!-- /.col -->
