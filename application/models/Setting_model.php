...
class Setting_model extends CI_Model
{
    ...
    public function update_payment_method($post)
    {
        ...
        $payment_data['google_pay_payment_method'] = isset($post['google_pay_payment_method']) ? '1' : '0';
        $payment_data['google_pay_mode'] = isset($post['google_pay_mode']) && !empty($post['google_pay_mode']) ? $post['google_pay_mode'] : '';
        $payment_data['google_pay_merchant_name'] = isset($post['google_pay_merchant_name']) && !empty($post['google_pay_merchant_name']) ? $post['google_pay_merchant_name'] : '';
        $payment_data['google_pay_merchant_id'] = isset($post['google_pay_merchant_id']) && !empty($post['google_pay_merchant_id']) ? $post['google_pay_merchant_id'] : '';
        $payment_data['google_pay_currency_code'] = isset($post['google_pay_currency_code']) && !empty($post['google_pay_currency_code']) ? $post['google_pay_currency_code'] : '';
        $payment_data['google_pay_country_code'] = isset($post['google_pay_country_code']) && !empty($post['google_pay_country_code']) ? $post['google_pay_country_code'] : '';
