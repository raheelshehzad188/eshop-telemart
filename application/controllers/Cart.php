...
class Cart extends CI_Controller
{
    ...
    public function cart_sync()
    {
        ...
        $user_id = $this->data['user']->id;
        $product_variant_id = array_column($post_data, "product_variant_id");
    ...
    public function place_order()
    {
        ...
        */
            ...
            // $this->form_validation->set_rules('payment_method', 'Payment Method', 'trim|required|xss_clean|in_list[Paystack,Paypal,Razorpay,COD,Stripe]');
