...
---------------------------------------------------------------------------
   ...
   37. get_promo_codes
   38. get_products_offline
   39. get_variants_offline
---------------------------------------------------------------------------
---------------------------------------------------------------------------
...
*/
    ...
    public function __construct()
    {
        ...
        $this->load->model(['category_model', 'order_model', 'rating_model', 'cart_model', 'Area_model', 'address_model', 'transaction_model', 'ticket_model', 'Order_model', 'notification_model', 'faq_model', 'Promo_code_model']);
    ...
    */
    ...
    public function get_products()
    {
        ...
        if (!$this->form_validation->run()) {
            ...
            $filters['search'] =  (isset($_POST['search']) && !empty($_POST['search'])) ? $_POST['search'] : null;
            ...
            if (!empty($products['product'])) {
                ...
                $this->response['search'] = (isset($_POST['search'])) ? $_POST['search'] : null;
