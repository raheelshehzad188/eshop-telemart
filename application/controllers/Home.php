...
class Home extends CI_Controller
{
    ...
    public function get_products()
    {
        ...
        if (!$this->form_validation->run()) {
            ...
            $order = (isset($_GET['order']) && !empty(trim($_GET['order']))) ? $this->input->post('order', true) : 'DESC';
            $sort = (isset($_GET['sort']) && !empty(trim($_GET['sort']))) ? $this->input->post('sort', true) : 'p.id';
            $filters['search'] =  (isset($_GET['search'])) ? $this->input->post('search', true)  : null;
            $filters['attribute_value_ids'] = (isset($_GET['attribute_value_ids'])) ? $_GET['attribute_value_ids'] : null;
            $category_id = (isset($_GET['category_id'])) ? $this->input->post('category_id', true) : null;
