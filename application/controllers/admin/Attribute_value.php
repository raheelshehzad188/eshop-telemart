	...
	public function add_attribute_value()
	{
		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
			...
			if (!$this->form_validation->run()) {
				...
				if (isset($_POST['edit_attribute_value'])) {
					//!edit_unique($this->input->post('attributes_id', true), 'attribute_values.attribute_id.'.$this->input->post('edit_attribute_value', true).'') && !edit_unique($this->input->post('value', true), 'attribute_values.value.'.$this->input->post('edit_attribute_value', true).'')
